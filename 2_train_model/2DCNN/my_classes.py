...
class DataGenerator(keras.utils.Sequence):
    def __init__(self, path_to_labs, path_to_img, batch_size, type, day, channels, shuffle=True):
        'Initialization'
        ...
        self.type = type
        self.day = day
        self.file_list_imgs = glob.glob(self.path_to_img + self.day + "/" + self.type + "/arrays/*.npy")
    ...
    def data_generation(self, list_IDs_temp):
        ...
        for sampidx in list_IDs_temp:
            tmp = np.load(self.file_list_imgs[sampidx]).squeeze()
            X_vals.append(tmp)
        ...
        for sampidx in list_IDs_temp:
            ...
            labpath = f'{self.path_to_labs}{self.day}/{self.type}/{sampname}'
