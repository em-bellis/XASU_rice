...
model = Sequential()
model.add(Conv3D(filters=64, kernel_size=(3,3,3), padding="same", activation='relu', input_shape=(5,5,5,7))) # 5x5 images with 5 timepoints and 7 channels (veg. indices)
